import { Co2EmissionMethodeInfoFetch, GasolineCo2EmissionInfo } from "./carbon-emmition";
...
export interface VehicleInfoFetch {
    ...
    vehicleGasolineTypeAndCo2Info: GasolineCo2EmissionInfo,
...
export interface WasteItemDef {
    ...
    // dumpingMethode: Co2EmissionMethodeInfoFetch,
    // processingMethode: Co2EmissionMethodeInfoFetch
...
export interface WasteItemSetMethode {
    wasteItemSetMethodeId: string,
    wasteItemId: string;
    companyId: string;
    dumpingMethode: Co2EmissionMethodeInfoFetch,
    processingMethode: Co2EmissionMethodeInfoFetch
