...
export class CaseStudyComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        // of(this.staticPage.staticContent).subscribe(tpl => this.divBinder.nativeElement.innerHTML = tpl);
    ...
    ngAfterViewInit(): void {
        ...
        if (!this.staticPage) {
            ...
            content.subscribe(tpl => this.divBinder.nativeElement.innerHTML = tpl);
            // this.divBinder.nativeElement.innerHTML = (this.staticPage) ? (this.staticPage.staticContent) : '';
        }
    ...
    loadStaticContent(data: StaticPageFetch) {
        ...
        if (!data) {
            ...
            var content: Observable<string> = of(data.staticContent);
            content.subscribe(tpl => this.divBinder.nativeElement.innerHTML = tpl);
