...
@Component({
    selector: 'app-how-to-use-it',
    templateUrl: './how-to-use-it.component.html',
    styleUrls: ['./how-to-use-it.component.css']
})
export class HowToUseItComponent implements OnInit {
    ...
    uiLabels: any = this.languageService.getUiLabels(AppConstant.COMP.HOW_TO_USE_IT, AppConstant.UI_LABEL_TEXT);
    componentCode!: string;
    isSystemAdmin: boolean = false;
    ngOnInit(): void {
        this.isSystemAdmin = this.utilService.languageEditMode();
        this.componentCode = AppConstant.COMP.HOW_TO_USE_IT;
